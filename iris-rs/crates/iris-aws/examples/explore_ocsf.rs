...
//!
//! Usage: `cargo run -p iris-aws --example explore_ocsf --release`

#![allow(clippy::too_many_lines)]

use chrono::{Duration, Utc};
use iris_core::catalog::{DataSource, DataSourceType};
use iris_core::connectors::base::DataConnector;
use iris_core::connectors::ocsf::{OCSFEventClass, SecurityLakeQueries};
use std::collections::HashMap;

use iris_aws::iceberg::IcebergConnector;
...
async fn main() {
    tracing_subscriber::fmt()
        .with_env_filter("info,iris_aws=debug")
        .init();
